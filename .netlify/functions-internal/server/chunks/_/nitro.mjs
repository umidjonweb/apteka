...
const _lazy_YZgnOA = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YZgnOA, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YZgnOA, lazy: true, middleware: false, method: undefined }
];
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "71a255f6-59aa-4f34-b6ee-5ec22f2227a8",
...
export { joinRelativeURL as a, useRuntimeConfig as b, getResponseStatusText as c, getResponseStatus as d, defineRenderHandler as e, getQuery as f, getRouteRulesForPath as g, createError$1 as h, getRouteRules as i, joinHeaders as j, normalizeCookieHeader as n, useNitroApp as u };
